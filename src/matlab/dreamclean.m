...
writetable(ind_var_table, '../../data/cleaned_ind.csv');
writetable(censoring_table, '../../data/cleaned_censor.csv');
writetable(surv_var_table, '../../data/cleaned_surv.csv');
writetable(ind_var22_table, '../../data/cleaned_ind22.csv');